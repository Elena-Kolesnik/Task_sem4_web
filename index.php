...
$works = [
    [
      ...
      "description" =>"Прохождение обучения по направлению Искусственный интеллект."
],
    [
      "name" =>"Главный Персональный менеджер",
      "dateStart" => "Сентябрь 2020",
      "dateEnd" => "Сентябрь 2022",
      "description" =>"Продажа инвестиционных продуктов."
    ],
    [
      "name" =>"Руководитель отдела продаж",
      "dateStart" => "Август 2016",
      "dateEnd" => "Август 2022",
      "description" =>"Руководcтво отделом."
    ],
];
?>
